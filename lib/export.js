...
exports.forLib = function (LIB) {
    ...
    exports.export = function (options) {
		...
		return LIB.Q.fcall(function () {
			...
			if (!options.config.source.server) return callback(null);
			if (!options.config.source.server.host) return callback(null);
			if (!options.config.pages) return callback(null);
